...
public class CoreDataContextObserver {
    ...
    public init(context: NSManagedObjectContext) {
        ...
        self.persistentStoreCoordinator = context.persistentStoreCoordinator
         ...
         NotificationCenter.default.addObserver(self, selector: #selector(CoreDataContextObserver.handleContextObjectDidChangeNotification(notification: )), name: NSNotification.Name.NSManagedObjectContextDidSave, object: context)
        
    }
    
    @objc private func handleContextObjectDidChangeNotification(notification: NSNotification) {
